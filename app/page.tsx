      ...
      <main>
        <section className="landingHero">
          <div>
            ...
            <p>
              Ойын, қызықты оқиға және Досша атты виртуалды дос арқылы қазақша
        ...
        <section className="landingFaq" aria-labelledby="faq-title">
          ...
          <details>
            <summary>Досша қалай көмектеседі?</summary>
            <p>
              Досша қазақ тілі ережелерін түсіндіруге және сөйлемдерді
