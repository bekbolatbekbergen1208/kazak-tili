...
QazaqDos беттеріндегі мәтіннің сөзін басқанда аударма терезесі ашылады.
Бастапқы тіл профильден алынады; терезеде орыс, ағылшын, қытай, испан,
неміс немесе француз тілін таңдауға болады. Терезе Escape арқылы жабылады.
Кәдімгі режимде сілтемелер мен батырмалар қалыпты әрекетін сақтайды.
«Барлық сөзді аудару» режимін қосқанда мәзір, сілтеме және жауап
батырмасындағы сөздер де басқанда аударылады; сол басу батырма әрекетін
орындамайды. Әрі қарай сайтты қолдану үшін режимді өшіріңіз.
Енгізу өрістеріне бұл режим әсер етпейді. Сабақ аудармашысына сөзді
қолмен енгізуге де болады: сөздікте болмаған сөз API арқылы аударылады.

`/api/translate` шағын кіріктірілген сөздіктен тыс сөздерді аудару үшін
аккаунтқа кіруді және сервердегі `OPENAI_API_KEY` баптауын талап етеді.
Модель қолданыстағы `OPENAI_MODEL` параметрінен алынады.
Аудармаға басылған сөз бен оның айналасындағы қысқа мәтін жіберіледі.
Әр аккаунтқа минутына 30 сұрау шегі бір сервер процесінде қолданылады;
бірнеше серверге көшкенде ортақ лимит қоймасы қажет.
Бұл мүмкіндік осы сайтқа арналған; басқа сайттар үшін браузер кеңейтімі керек.
