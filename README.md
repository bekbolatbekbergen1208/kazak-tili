...
қолмен енгізуге де болады: аударма тек кіріктірілген сөздіктен алынады.

`/api/translate` тек шағын кіріктірілген сөздіктегі сөздерді аударады.
Белгісіз сөздер сыртқы AI қызметіне жіберілмейді, сондықтан аударма үшін
ақылы API шығыны болмайды.
