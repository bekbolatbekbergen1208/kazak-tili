...
const student = [
  ["/learn", LayoutDashboard, "Жеке бағдарлама"],
  ["/student", LayoutDashboard, "Басты бет"],
  ["/student/lessons", BookOpen, "1000 сабақ"],
...
export function Shell({
  ...
  const path = usePathname(),
    links = role === "student" ? student : teacher;
  return (
    <div className={`appShell ${role}`}>
      <aside>
...
export function StudentTop({ title, sub }: { title: string; sub?: string }) {
  return (
    <header className="top">
      ...
      <div className="topStats">
        ...
        <span className="points">✦ 1 240</span>
