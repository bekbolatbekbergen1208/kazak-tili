...
const videoDictionaries: Record<string, Word[]> = {
  "zsrcsLcbKMc": [
    { kk: "қошқар", ru: "баран", note: "кейіпкер" }, { kk: "ауыл", ru: "аул, деревня", note: "туған жер" }, { kk: "сағыну", ru: "скучать", note: "сағындым" }, { kk: "қайта", ru: "снова, обратно", note: "қайта оралу" }, { kk: "жақсы", ru: "хороший", note: "баға беру" }, { kk: "теке", ru: "козёл", note: "кейіпкер" }, { kk: "әке", ru: "отец", note: "туыс" }, { kk: "апа", ru: "старшая сестра", note: "туыс" }, { kk: "бару", ru: "идти, ехать", note: "әрекет" }, { kk: "келу", ru: "приходить", note: "әрекет" }, { kk: "дос", ru: "друг", note: "жақын адам" }, { kk: "көру", ru: "видеть", note: "әрекет" }, { kk: "қуаныш", ru: "радость", note: "сезім" }, { kk: "көп", ru: "много", note: "мөлшер" }, { kk: "күш", ru: "сила", note: "қабілет" }, { kk: "керек", ru: "нужно", note: "қажеттілік" }, { kk: "жануар", ru: "животное", note: "тіршілік иесі" },
  ],
  "y03JllPau0Y": [
    { kk: "сәлем", ru: "привет", note: "амандасу" }, { kk: "балақай", ru: "малыш", note: "балаға қарату" }, { kk: "Мақта қыз", ru: "Макта кыз", note: "кейіпкер" }, { kk: "мысық", ru: "кошка", note: "кейіпкер" }, { kk: "құйрық", ru: "хвост", note: "дене мүшесі" }, { kk: "достық", ru: "дружба", note: "ертегінің тақырыбы" }, { kk: "ертегі", ru: "сказка", note: "әңгіме" }, { kk: "оқу", ru: "читать", note: "әрекет" }, { kk: "үй", ru: "дом", note: "мекен" }, { kk: "шақыру", ru: "звать", note: "әрекет" }, { kk: "қатық", ru: "простокваша", note: "тағам" }, { kk: "сиыр", ru: "корова", note: "кейіпкер" }, { kk: "жапырақ", ru: "лист", note: "зат" }, { kk: "су", ru: "вода", note: "зат" }, { kk: "тауық", ru: "курица", note: "кейіпкер" }, { kk: "жұмыртқа", ru: "яйцо", note: "зат" }, { kk: "дән", ru: "зерно", note: "тағам" }, { kk: "сәбіз", ru: "морковь", note: "тағам" }, { kk: "сұрау", ru: "просить, спрашивать", note: "әрекет" },
  ],
  "kjKrMStb8E0": [
    { kk: "жер", ru: "земля", note: "мекен" }, { kk: "бай", ru: "богач", note: "ертегі кейіпкері" }, { kk: "қыз", ru: "девочка, дочь", note: "кейіпкер" }, { kk: "үй", ru: "дом", note: "тұратын жер" }, { kk: "болыпты", ru: "оказывается, жил-был", note: "ертегінің басталуы" }, { kk: "ертегі", ru: "сказка", note: "оқиға түрі" }, { kk: "ана", ru: "мать", note: "туыс" }, { kk: "аға", ru: "старший брат", note: "туыс" }, { kk: "кіші", ru: "младший", note: "сипаттама" }, { kk: "көйлек", ru: "платье", note: "киім" }, { kk: "әдемі", ru: "красивый", note: "сипаттама" }, { kk: "сарай", ru: "дворец", note: "мекен" }, { kk: "кеш", ru: "вечер", note: "уақыт" }, { kk: "сағат", ru: "час", note: "уақыт" }, { kk: "аяқ киім", ru: "обувь", note: "киім" }, { kk: "түн", ru: "ночь", note: "уақыт" }, { kk: "орман", ru: "лес", note: "мекен" }, { kk: "табу", ru: "найти", note: "әрекет" },
  ],
  "dHW2YHwkiMw": [
    { kk: "баяғыда", ru: "давным-давно", note: "ертегінің басталуы" }, { kk: "Мақта қыз", ru: "Макта кыз", note: "кейіпкер" }, { kk: "мысық", ru: "кошка", note: "кейіпкер" }, { kk: "құйрық", ru: "хвост", note: "дене мүшесі" }, { kk: "сүт", ru: "молоко", note: "тағам" }, { kk: "көмек", ru: "помощь", note: "оқиға тақырыбы" }, { kk: "шақыру", ru: "звать", note: "әрекет" }, { kk: "қию", ru: "резать", note: "әрекет" }, { kk: "сиыр", ru: "корова", note: "кейіпкер" }, { kk: "қатық", ru: "простокваша", note: "тағам" }, { kk: "жапырақ", ru: "лист", note: "зат" }, { kk: "су", ru: "вода", note: "зат" }, { kk: "тауық", ru: "курица", note: "кейіпкер" }, { kk: "жұмыртқа", ru: "яйцо", note: "зат" }, { kk: "тышқан", ru: "мышь", note: "кейіпкер" }, { kk: "бидай", ru: "пшеница", note: "тағам" }, { kk: "қуанған", ru: "обрадованный", note: "сезім" }, { kk: "қайтару", ru: "вернуть", note: "әрекет" }, { kk: "рақмет", ru: "спасибо", note: "алғыс" },
  ],
  "D2vA2-rYXpg": [
